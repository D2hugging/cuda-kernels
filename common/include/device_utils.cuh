 ...
 * @tparam BlockSize The block size (must be known at compile time for optimization)
 ...
 */
template <typename T>
__device__ __forceinline__ void blockReduceSumDynamic(T* smem, int tid, int blockSize) {
    __syncthreads();
